    ...
    return (
        <section className="relative h-screen flex items-center justify-center text-center text-white" style={{ backgroundImage: `url(${siteContent.heroBackgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            ...
            <div className="relative z-10 p-4">
                <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-4 animate-fade-in-down" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.7)'}}>
                    Selamat Datang di Website Resmi
                </h1>
                <p className="text-5xl md:text-7xl font-bold text-brand-yellow-400 mb-8 animate-fade-in-up" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.7)'}}>
